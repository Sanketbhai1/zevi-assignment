...
## Deployed Site Link :https://zevi-search-app-sanketwalunj.netlify.app/
...
To update state in React, we use this.setState - we don't set it directly except in the constructor. setState only takes the properties we're interested in updating and our component will re-render as appropriate.
